...
$classes 	= "ingenious_banner" . ( empty( $url ) ? " ingenious_module" : "" );
...
/* \icon styles */
$out .= !empty( $url ) ? "<a class='banner_link ingenious_module' href='$url'>" : "";
	$out .= "<span id='$banner_id' class='$classes'" . ( !empty( $section_styles ) ? " style='$section_styles'" : "" ) . ">";
		$out .= "<span class='banner_wrapper clearfix'>";
			$out .= !empty( $icon )	 ? "<span class='banner_icon'" . ( !empty( $icon_styles ) ? " style='$icon_styles'" : "" ) . "><i class='$icon'></i></span>" : "";
