				...
				if( have_posts() ){
					echo "<section id='$section_id' class='posts_grid search_posts_grid'>";
						echo "<div class='ingenious_wrapper'>";
							echo "<div class='ingenious_grid isotope'>";
								wp_enqueue_script ('isotope');
								$use_pagination = $max_paged > 1;
									while( have_posts() ) : the_post();									
										ingenious_searchPostsGrid_post ();							
									endwhile;
									wp_reset_postdata();
							echo "</div>";
						echo "</div>";
					...
					echo "<div class='ingenious_msg_box ingenious_module info' type='info' title='" . esc_html__( "No search Results", 'ingenious' ) . "'>" . esc_html__( "There are no posts matching your query", 'ingenious' ) . "</div>";
