		...
		echo "<main id='page_content'>";
			while ( have_posts() ) : the_post();
				...
				echo "<article id='attachment_post_{$pid}' class='attachment_post post_single clearfix'>";
					...
					$thumbnail_dims = ingenious_get_post_thumbnail_dims( false, $real_thumbnail_dims );
				...
				ob_start();
				$prev_link_text = is_rtl() ? "<span>" . esc_html__( 'Previous Image', 'ingenious' ) . "</span>&#x20;<i class='fa fa-angle-double-right'></i>" : "<i class='fa fa-angle-double-left'></i>&#x20;<span>" . esc_html__( 'Previous Image', 'ingenious' ) . "</span>";
				$next_link_text = is_rtl() ? "<i class='fa fa-angle-double-left'></i>&#x20;<span>" . esc_html__( 'Nexts Image', 'ingenious' ) . "</span>" : "<span>" . esc_html__( 'Next Image', 'ingenious' ) . "</span>&#x20;<i class='fa fa-angle-double-right'></i>";
